...
Please select your next action:
    1. Regenerate specific sections or the entire infographic using the current data.
    2. Modify the infographic with suggestions.
    3. Add more information to the infographic.
    4. Retry generating the entire infographic.
    5. Return to the previous step.
Enter the number corresponding to your choice (1-5) : """

STEP_1_MENU = """
Which parts of the infographic would you like to be regenerated?
    1. Entire infographic
    2. Figures
    3. Graph
...
STEP_2_MENU = """
Please select how you would like to apply suggestions.
...
def report_evaluation(evaluation, target_score):
    """Displays the infographic evaluation with scores and suggestions."""
    print("Current infographic ratings and suggestions:")
    ...
    for criteria, details in evaluation.items():
        if isinstance(details, dict):
            ...
            print(f"Summary of Calculations: {calculation}")
...
def save_infographic(info_img, out_dir):
